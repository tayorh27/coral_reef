...
class LinearDatePickerForCycle extends StatefulWidget {
  final bool showDay,showMonth,showYear;
...
class _LinearDatePickerState extends State<LinearDatePickerForCycle> {
  int _selectedYear;
  int _selectedMonth;
  int _selectedDay;
  ...
  bool showDay,showMonth,showYear;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Container(
                    height: (showDay) ? 100.0 : 300.0,
                    child: Visibility(visible: showYear,child: NumberPicker.integer(
