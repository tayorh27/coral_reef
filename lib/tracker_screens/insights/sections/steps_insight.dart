...
class StepsInsight extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _StepsInsight();
}

class _StepsInsight extends State<StepsInsight> {
  ...
  getInitialChartData() async {
    ...
    setState(() {
      ...
      if(stepsData.isNotEmpty) {
        stepsCount = stepsData[0].glasses_count;
        createdDate = (selectedDataByType == "Days") ? "${stepsData[0].week}, ${stepsData[0].month} ${stepsData[0].day}" : "${stepsData[0].created_date}";
      }
    });
  }
        ...
        children: <Widget>[
          Container(
            ...
            child: PillIcon(
              ...
              size: 40,
              svgColor: Color(MyColors.primaryColor),
            ),
          ),
          Text('$stepsCount',textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.headline2.copyWith(
              color: Colors.black,
              fontSize: getProportionateScreenWidth(27),
            ),),
          Text('Average steps taken', textAlign: TextAlign.center,
    ...
    return BarChart(
      BarChartData(
        ...
        barTouchData: BarTouchData(
          ...
          setState(() {
            stepsCount = stepsData[index].glasses_count;
            createdDate = (selectedDataByType == "Days") ? "${stepsData[index].week}, ${stepsData[index].month} ${stepsData[index].day}" : "${stepsData[index].created_date}";
          });
