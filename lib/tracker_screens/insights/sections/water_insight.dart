...
class WaterInsight extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _WaterInsight();
}

class _WaterInsight extends State<WaterInsight> {
  ...
  String waterCount = "N/A", createdDate = "N/A";
  ...
  getInitialChartData() async {
    ...
    Map<String, dynamic> data = await dewServices.getWaterDataInsight(selectedDataByType);
    setState(() {
      waterData = data["data"];
      ...
      if(waterData.isNotEmpty) {
        waterCount = waterData[0].glasses_count;
    ...
    return Container(
      ...
      child:  Column(
        ...
        children: <Widget>[
          ...
          Text('$waterCount',textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.headline2.copyWith(
              color: Colors.black,
              fontSize: getProportionateScreenWidth(27),
            ),),
          Text('Average glasses taken', textAlign: TextAlign.center,
    ...
    return BarChart(
      BarChartData(
        ...
        barTouchData: BarTouchData(
          ...
          setState(() {
            waterCount = waterData[index].glasses_count;
