...
class VitaminsInsight extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _VitaminsInsight();
}

class _VitaminsInsight extends State<VitaminsInsight> {
  ...
  String vitaminCount = "N/A", createdDate = "N/A";
  ...
  getInitialChartData() async {
    ...
    Map<String, dynamic> data = await dewServices.getVitaminsDataInsight(selectedDataByType);
    setState(() {
      vitaminsData = data["data"];
      rawBarGroups = data["chart"];
      showingBarGroups = rawBarGroups;

      if(vitaminsData.isNotEmpty) {
        vitaminCount = vitaminsData[0].vitamin_count;
        createdDate = (selectedDataByType == "Days") ? "${vitaminsData[0].week}, ${vitaminsData[0].month} ${vitaminsData[0].day}" : "${vitaminsData[0].created_date}";
      }
    });
  }
    ...
    return Container(
      ...
      child:  Column(
        ...
        children: <Widget>[
          ...
          Text('$vitaminCount',textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.headline2.copyWith(
              color: Colors.black,
              fontSize: getProportionateScreenWidth(27),
            ),),
          Text('Average\nVitamin pills\ntaken', textAlign: TextAlign.center,
    ...
    return BarChart(
      BarChartData(
        ...
        barTouchData: BarTouchData(
          ...
          setState(() {
            vitaminCount = vitaminsData[index].vitamin_count;
            createdDate = (selectedDataByType == "Days") ? "${vitaminsData[index].week}, ${vitaminsData[index].month} ${vitaminsData[index].day}" : "${vitaminsData[index].created_date}";
          });
