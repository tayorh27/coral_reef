...
class VitaminGoal extends StatefulWidget {
  static final routeName = "vitamin-goals";

  @override
  State<StatefulWidget> createState() => _VitaminGoal();
}

class _VitaminGoal extends State<VitaminGoal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: DietHeader("Vitamins").appBar(context),
      body: SafeArea(
          child: SizedBox(
                                           ...
                                           child:  Column(
                                             ...
                                             mainAxisAlignment: MainAxisAlignment.center,
                                               children: <Widget>[
                                                 ...
                                                 Text('$currentTakenVitamins/$vitaminsGoal',textAlign: TextAlign.center,
    ...
    return showDialog<bool>(
        ...
        builder: (context) {
          return AlertDialogPage(
              title: "Add Vitamins Count",
              initialValue: vitaminsGoal,
