...
import 'package:coral_reef/services/track_step_service.dart';
...
class TrackActivity extends StatefulWidget {
  static final routeName = "trackActivity";
  @override
  _PageState createState() => _PageState();
}

class _PageState extends State<TrackActivity> {
  ...
  TrackStepService trackStepService;
  ...
  setupPhysicalActivityTracking() async {
    ...
    if (await ph.Permission.activityRecognition.request().isGranted) {
      ...
      trackStepService = new TrackStepService(context,
          onStepChange: (steps, distance, timestamp) async {
      ...
      trackStepService.pauseCounting();
    }
  }
  ...
  updateChallengeForegroundData(LocationData result) async {
    ...
    await ss.setPrefItem(
        "currentTime", ct.add(Duration(seconds: 1)).toString());
  ...
  void onMapCreated(GoogleMapController controller) async {
    ...
    setState(() {
      ...
      _markers.add(Marker(
          ...
          position: LatLng(locationService.currentLocation.latitude,
  ...
  saveDataAndCancelSubscription() async {
    ...
    if (trackStepService != null) trackStepService.stopCounting();
                                ...
                                children: [
                                  InkWell(
                                      onTap: () async {
                                        ...
                                        if (trackStepService != null)
                                          trackStepService.stopCounting();
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        ...
                                        if (trackStepService != null)
                                          trackStepService.resumeCounting();
                                        setState(() {
                                          actionButton = 'play';
                                        });
                                      },
  ...
  getActivityData() async {
    ...
    if (actionButton == "pause") {
      ...
      if (trackStepService != null) trackStepService.pauseCounting();
    }

    if (actionButton == "play") {
      if (trackStepService != null) trackStepService.resumeCounting();
    }
