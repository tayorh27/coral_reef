...
class _PageState extends State<ExerciseInsight> {
  List<Map<String,dynamic>> screens = [
    {"screen_name": "Steps", "screen_route": "insightSteps", "screen_class":InsightSteps()},
    {"screen_name": "Pregnancy tracker", "screen_route": "pregnancy-tracker-screen", "screen_class":InsightSteps()},
    {"screen_name": "Diet tracker", "screen_route": "diet-tracker-screen", "screen_class":InsightSteps()},
    {"screen_name": "Exercise tracker", "screen_route": "exercise-tracker-screen", "screen_class":InsightSteps()},
    {"screen_name": "Well-being tracker", "screen_route": "well-being-tracker-screen", "screen_class":InsightSteps()},
  ];
        ...
        body: Padding(
            ...
            child:
              ...
              Container(
                ...
                child: ExerciseScrollingOptions(onSelectedMenu: (String selectedMenu) {
